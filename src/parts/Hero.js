        ...
        <div className="row align-items-center">
            <div className="col-auto pr-5" style={{width: 530}}>
                <h1 className="font-weight-bold line-height-1 mb-3">
                    Forget Your Main Work, <br/> 
                    Start Holiday Now!
                </h1>
                <p className="mb-4 font-weight-light text-gray-500 w-75" style={{lineHeight :"170%"}}>
                We provide you what you need to enjoy your holiday with 
            ...
            <div className="col-6 pl-5">
                <div style={{ width: 540, height: 410 }}>
                    <div style={{width: 540, height : 410}}>
                        <img  src={ImageHero} alt="Room with couches" className="position-absolute" style={{margin: '-30px 0 0 -30px', 
                        zIndex:1, width: "90%"}} />
                        <img src={ImageHero_} alt="Room with couches frame" className="position-absolute" style={{margin: '-0 -15px -15px 0', width: "90%"
                        }} />
                    </div>
                </div>
            </div>
